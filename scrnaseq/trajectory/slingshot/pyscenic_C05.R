...
png("figures/16_pyscenic_unintegrated/pyscenic_C05_knots.png", width = 1500*5, height = 500*5, res = 78*5)
icMat <- evaluateK(counts = counts, pseudotime = pseudotime[cells_keep,6], cellWeights = cell.weights[cells_keep,6], k = 3:20, nGenes = 100, verbose = T, parallel = TRUE)
dev.off()
