...
f_pyscenic = [str(iteration_path) + "output/pyscenic_output_" + str(s) + '.loom' for s in range(61,81)]
adj = [str(iteration_path) + "adj/adj_" + str(s) + ".csv" for s in range(61,81)]
reg = [str(iteration_path) + "reg/reg_" + str(s) + ".csv" for s in range(61,81)]
